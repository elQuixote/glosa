...
proc headingXY_v3*(v: Vector3): float {.cdecl, exportc, dynlib.} = headingXY(v)
proc headingXZ_v3*(v: Vector3): float {.cdecl, exportc, dynlib.} = headingXZ(v)
proc headingYZ_v3*(v: Vector3): float {.cdecl, exportc, dynlib.} = headingYZ(v)
